<template>
  <div style="color: black;" class="container mt-5">
    <h2 style="color:white;" class="mb-4">Arte e Astronomía</h2>
    <div v-if="isLoggedIn">
...
const post = ref({
  name: '',
  description: '',
  type: 'ARTE_ASTRONOMIA',
  relatedImages: [],
});

const fetchPosts = async () => {
  try {
    const response = await axios.get('http://localhost:8080/stellarium/posts/search?type=ARTE_ASTRONOMIA');
